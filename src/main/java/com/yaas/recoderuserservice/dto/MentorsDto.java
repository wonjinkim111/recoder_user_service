...
public class MentorsDto {
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof com.yaas.recoderuserservice.dto.MentorsDto))
            return false;
        com.yaas.recoderuserservice.dto.MentorsDto other = (com.yaas.recoderuserservice.dto.MentorsDto)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.yaas.recoderuserservice.dto.MentorsDto;
    }
    ...
    public String toString() {
        return "MentorsDto(mentorId=" + getMentorId() + ", userId=" + getUserId() + ", mentorNickname=" + getMentorNickname() + ", introduction=" + getIntroduction() + ", regDate=" + getRegDate() + ")";
    }

    public MentorsDto(long mentorId, long userId, String mentorNickname, String introduction, Date regDate) {
        this.mentorId = mentorId;
        this.userId = userId;
        this.mentorNickname = mentorNickname;
        this.introduction = introduction;
    ...
    public MentorsDto(long mentorId) {
        this.mentorId = mentorId;
    }

    public MentorsDto(String mentorNickname) {
        this.mentorNickname = mentorNickname;
    }

    public MentorsDto(long mentorId, String mentorNickname) {
        this.mentorId = mentorId;
        this.mentorNickname = mentorNickname;
    }

    public MentorsDto(String mentorNickname, String introduction) {
        this.mentorNickname = mentorNickname;
        this.introduction = introduction;
    }
}
